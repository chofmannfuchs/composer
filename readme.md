...
The Composer-Service is a pre-configured Docker container that can be used in the *kotlin-workshop* to compose the frontend components of the microservices.
...
To build the composer service for the *kotlin-workshop* you need to have the following tools installed:
 - Docker
 - OpenJDK 17
